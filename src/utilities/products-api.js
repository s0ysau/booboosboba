...
export const categories = [
  { id: 10, name: 'Speciality Drinks', sortNumber: 10 },
  { id: 20, name: 'Tea', sortNumber: 20 },
  { id: 30, name: 'Coffee', sortNumber: 30 },
  { id: 40, name: 'Caffeine Free', sortNumber: 40 },
  { id: 50, name: 'Seasonal Drinks', sortNumber: 50 },
  { id: 60, name: 'Merch', sortNumber: 60 }
]
